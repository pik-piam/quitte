...
R package **quitte**, version **0.3083.1**
...
and pieces of code to use with quitte-style data frames_. R package version 0.3083.1, <URL:
...
@Manual{,
  ...
  year = {2020},
  note = {R package version 0.3083.1},
