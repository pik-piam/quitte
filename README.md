...
R package **quitte**, version **0.3132.1**
...
Pehl M, Bauer N, Hilaire J, Levesque A, Luderer G, Schultes A, Dietrich J, Richters O (2024). _quitte: Bits and pieces of code to use with quitte-style data frames_. R package version 0.3132.1, <URL: https://github.com/pik-piam/quitte>.
...
@Manual{,
  ...
  year = {2024},
  note = {R package version 0.3132.1},
