...
R package **quitte**, version **0.3108.2**
...
Pehl M, Bauer N, Hilaire J, Levesque A, Luderer G, Schultes A, Dietrich J, Richters O (2023). _quitte: Bits and pieces of code to use with quitte-style data frames_. R package version 0.3108.2, <https://github.com/pik-piam/quitte>.
...
@Manual{,
  ...
  year = {2023},
  note = {R package version 0.3108.2},
