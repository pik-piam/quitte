...
R package **quitte**, version **0.3082.0**
...
and pieces of code to use with quitte-style data frames_. R package version 0.3082.0, <URL:
...
@Manual{,
  ...
  year = {2020},
  note = {R package version 0.3082.0},
