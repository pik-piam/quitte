...
R package **quitte**, version **0.3143.1.9001**
...
Pehl M, Bauer N, Hilaire J, Levesque A, Luderer G, Schultes A, Dietrich J, Richters O (2025). "quitte: Bits and pieces of code to use with quitte-style data frames." Version: 0.3143.1.9001, <https://github.com/pik-piam/quitte>.
