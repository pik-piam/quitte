...
R package **quitte**, version **0.3141.2**
...
Pehl M, Bauer N, Hilaire J, Levesque A, Luderer G, Schultes A, Dietrich J, Richters O (2025). "quitte: Bits and pieces of code to use with quitte-style data frames." Version: 0.3141.2, <https://github.com/pik-piam/quitte>.
