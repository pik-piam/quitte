...
R package **quitte**, version **0.3084.3**
...
and pieces of code to use with quitte-style data frames_. R package version 0.3084.3, <URL:
...
@Manual{,
  ...
  year = {2020},
  note = {R package version 0.3084.3},
