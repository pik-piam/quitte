...
- **Michaja Pehl**. Author, maintainer.

- **Nico Bauer**. Author.

- **Jérôme Hilaire**. Author.

- **Antoine Levesque**. Author.

- **Gunnar Luderer**. Author.

- **Anselm Schultes**. Author.
...
Source:
[`DESCRIPTION`](https://github.com/pik-piam/quitte/blob/master/DESCRIPTION)
