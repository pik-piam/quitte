...
#' @param mapping An aesthetic mapping generated by
#'     \code{\link[ggplot2:aes]{aes()}}, containing the aesthetics \code{x},
#'     \code{y}, \code{fill}, and \code{dodge}.  The aesthetic \code{x} will
#'     form groups on the x-axis, while \code{dodge} will form individual bars
#'     within the groups.
...
#'     for use with
#'     \code{\link[ggplot2:scale_x_continuous]{scale_x_continuous()}}.
#'     \code{ggplot_bar_stacked_dodged()} returns a
